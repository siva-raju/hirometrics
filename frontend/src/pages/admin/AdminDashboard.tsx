...
export default function AdminDashboard() {
  ...
  const { data: allUsers = [] } = useQuery({
    ...
    queryFn: () => adminApi.listAllUsers().then(r => r.data)
  });
  const totalCandidates = (allUsers as any[]).filter((u: any) => u.role === 'applicant').length;
  ...
  const pendingVerifications = (activeRequests as any[]).length;
  ...
  return (
    <div className="max-w-6xl fade-in">
      ...
      <div className="grid grid-cols-4 gap-4 mb-7">
        ...
        <StatCard value={totalCandidates || "—"} label="Total Candidates" icon="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0" accent="#f0963c" bg="#fef3ea" />
        <StatCard value={pendingVerifications} label="Pending Verifications" icon="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" accent="#f0b400" bg="#fef9e7" />
      </div>
