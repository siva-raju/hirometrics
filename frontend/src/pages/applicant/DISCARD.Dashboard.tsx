...
export default function ApplicantDashboard() {
  ...
  const profileStatus: 'complete' | 'in_progress' = isLocked ? 'complete' : 'in_progress';
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="space-y-0 divide-y divide-gray-100">
            ...
            <div className="pt-4">
              <Link
                ...
                {profileStatus === 'complete' ? 'Update Profile →' : 'Continue Wizard →'}
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <CheckRow label="Resume"         done={hasResume}    missing={!hasResume && wizardStep >= 6} />
          </div>
